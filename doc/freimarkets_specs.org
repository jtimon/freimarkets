...
#+BEGIN_SRC bitcoin
<refheight> <amount> <tokens> <scriptPubKey> <chain_id> <asset_id> <from> <to> OUTPUT_EXISTS
#+END_SRC
...
#+BEGIN_SRC bitcoin
<refheight> <amount> <tokens> <scriptPubKey> FRC_CHAIN_ID <asset_id> BLOCK_HEIGHT BLOCK_HEIGHT OUTPUT_EXISTS
#+END_SRC
...
Ant-Money laundering enforcement. For example, U.S. dollar gateways
