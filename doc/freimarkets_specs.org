...
The input script (script1) uses p2sh and works like this:
...
The seller completes and broadcast the transaction adding:

#+BEGIN_SRC bitcoin
input: Q pubA
output: P pubB to seller2
#+END_SRC
...
** MODIFY [0/6] Trades involving off-chain assets
