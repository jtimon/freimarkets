...
#+BEGIN_SRC bitcoin
<chain_id> <tx_id> <output number> <height> OUTPUT_SPENT
#+END_SRC
...
#+BEGIN_SRC bitcoin
<chain_id> <from> <to> <asset_id> <scriptPubKey> <tokens> <refheight> <amount> OUTPUT_EXISTS
#+END_SRC
...
#+BEGIN_SRC bitcoin
<tx_id> <output number> <freicoin chain_id> BLOCK_HEIGHT OUTPUT_SPENT
#+END_SRC
...
#+BEGIN_SRC bitcoin
<asset_id> <scriptPubKey> <tokens> <refheight> <amount> OUTPUT_EXISTS_IN
#+END_SRC

It is almost equivalent to the following script:

#+BEGIN_SRC bitcoin
FRC_CHAIN_ID BLOCK_HEIGHT BLOCK_HEIGHT <asset_id> <scriptPubKey> <tokens> <refheight> <amount> OUTPUT_EXISTS
#+END_SRC
...
validation scriptPubKey:
    ...
    FROMALTSTACK (expiry) seller1 pubA FRC_CHAIN_ID OUTPUT_EXISTS
#+END_SRC
